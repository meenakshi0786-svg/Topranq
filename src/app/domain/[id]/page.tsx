  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-10">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 16 }} className="mb-8">
          ...
          <NavCard href={`/domain/${domainId}/visibility`} icon="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z M15 12a3 3 0 11-6 0 3 3 0 016 0z" title="AI Visibility" desc="ChatGPT, Perplexity…" />
